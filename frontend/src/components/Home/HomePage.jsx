...
const HeroSection = () => {
  return (
    <>
      <div className="bg-gradient-to-r from-pink-800 to-orange-500 text-white py-20 px-4">
        <div className="max-w-7xl mx-auto flex flex-col items-center">
          {/* Heading */}
          <h1 className="text-5xl font-bold text-center text-customGold">
            Track Your Expenses Effortlessly
          </h1>

          {/* Subheading */}
          <p className="mt-4 text-xl text-center text-pink-950">
          ...
          <div className="flex space-x-8 mt-10">
            <div className="flex flex-col items-center">
              <FaMoneyBillWave className="text-3xl text-customGold" />
              <p className="mt-2 text-pink-950">Efficient Tracking</p>
            </div>
            <div className="flex flex-col items-center">
              <FaFilter className="text-3xl text-customGold" />
              <p className="mt-2 text-pink-950">Transactions Filtering</p>
            </div>
            <div className="flex flex-col items-center">
              <IoIosStats className="text-3xl text-customGold" />
              <p className="mt-2 text-pink-950">Insightful Reports</p>
            </div>
          </div>

          {/* Call to Action Button */}
          <Link to="/register">
            <button className="mt-8 px-6 py-3 bg-customGold text-pink-900 font-semibold rounded-lg shadow-md hover:bg-gray-100 transition duration-300">
              Get Started
            </button>
          </Link>
        </div>
      ...
      {/* How it works */}
      <div className="py-20 px-4 bg-pink-200">
      ...
      {/* Testimonials */}
      <div className="bg-customGold py-20 px-4">
        <h2 className="text-3xl font-bold text-center text-gray-800">
          What Our Users Say
        </h2>
      ...
      {/* CTA */}
      <div className="bg-pink-800 text-white py-20 px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <Link to="/register">
            <button className="mt-8 px-6 py-3 bg-customGold text-black font-semibold rounded-lg shadow-md hover:bg-gray-100 transition duration-300">
              Sign Up For Free
            </button>
          </Link>
        </div>
